    ...
    return (function () {
        return {
            'speak': function (speechOutput) {
                ...
                responseObject.response.shouldEndSession = true;
                return this;
            },
            ...
            // BodyTemplate1 - Full-width text 
            'bodyTemplateOne': function (token, backButton, backgroundImage, title, textContent) {
                var templateRenderDirective = {
                ...
                responseObject.response.directives = [templateRenderDirective];
                return this;
            },
            // BodyTemplate2 - Image Right
            'bodyTemplateTwo': function (token, backButton, backgroundImage, title, image, textContent) {
                var templateRenderDirective = {
                    "type" : "Display.RenderTemplate",
                    "template" : {
                        "type": "BodyTemplate2",
            ...
            // BodyTemplate3 - Image left 
            'bodyTemplateThree': function (token, backButton, backgroundImage, title, image, textContent) {
                var templateRenderDirective = {
                    "type" : "Display.RenderTemplate",
                    "template" : {
                        "type": "BodyTemplate3",
            ...
            // BodyTemplate 6 - Full-screen image with text overlay
            'bodyTemplateSix': function (token, backButton, backgroundImage, title, image, textContent) {
                var templateRenderDirective = {
                    "type" : "Display.RenderTemplate",
                    "template" : {
                        "type": "BodyTemplate6",
             ...
             // ListTemplate 1 - Vertical List
            'listTemplateOne': function (token, backButton, backgroundImage, title, image, listItems) {
                var templateRenderDirective = {
                    "type" : "Display.RenderTemplate",
                    "template" : {
                        "type": "ListTemplate1",
            ...
            // ListTemplate 2 - Horizontal list with text under image
            'listTemplateTwo': function (token, backButton, backgroundImage, title, image, listItems) {
                var templateRenderDirective = {
                    "type" : "Display.RenderTemplate",
                    "template" : {
                        "type": "ListTemplate2",
            ...
            'hintHelper': function (text) {
              var hintDirective = {
                ...
                if (Array.isArray(responseObject.response.directives)) {
                    console.log('Existing Directive Array');
                    responseObject.response.directives.push(hintDirective);
                } else {
                    console.log('New Directive Array');
                    responseObject.response.directives = [hintDirective];
                }             
                return this;
            },
           
             // VideoApp Launch - Plays a Video
            'videoPlay': function (source, metadata) {
                var videoPlayDirective = {
                ...
                // Set outputSpeech to null
                responseObject.response.outputSpeech = null;
                // Removes shouldEndSession flag from Response
                delete responseObject.response['shouldEndSession'];
                responseObject.response.directives = [videoPlayDirective];
                return this;
            },
